    ...
    public class TestModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            var sections = new List<ContentSection>()
            {
                ...
                //    ImagesLeft =
                //    [
                //        new() { ImageUrl = "images/image-position-model.png" }
                //    ],
                //    ParagraphsRight =
                //    [
                //        new() 
                ...
                //    ImagesRight =
                //    [
                //        new() { ImageUrl = "images/content-section.png" }
                //    ],
                //    PaddingsCss = "pt-3",
                //    BackgroundColorCss = "section-bg",
                //    SpaceBottom = false
                ...
                new FlexSection
                {
                    ...
                    [
                        new()
                        {
                            Text = "Sedan renderas bilden på rätt plats i vyn, i detta fallet så är det en topp/botten placering (kunde ha gjort detta enklare med bara css-klasser...men detta får vara just nu)."
                        }
                    ],          
                    ImagesRight =
                    [
                ...
                new TextSection
                {
                    ...
                    Paragraphs =
                    {
                        ...
                        { 
                            ...
                            "Tanken är dock att tjänstelagret framöver ska delas upp i mer specialiserade tjänster med tydligare ansvarsområden men just nu " +
                            "när systemet inte är så stort så fungerar det utmärkt"
                        },
                        new()
                        {
                            Text = "amtidigt finns planer på att införa en gemensam basklass för repositories för att minska duplicerad kod och skapa " +
                            "en mer enhetlig dataåtkomst."
                        },
                        new()
                        {
                            Text = "Utöver detta finns redan en separat PageRendererService som ansvarar för delar av renderingsprocessen."
                        },
                    },
                    BackgroundColorCss = "section-bg",
                    BordersCss = "border-all border-primary"
